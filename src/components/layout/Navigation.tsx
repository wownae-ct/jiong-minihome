      ...
      {navItems.map((item) => {
        ...
        return (
          <button
            ...
            className={`
              flex-1 sm:flex-none min-w-0 relative px-1.5 sm:px-4 md:px-6 py-2 md:py-3 text-sm md:text-base rounded-t-xl transition-all whitespace-nowrap cursor-pointer
              ${isActive
